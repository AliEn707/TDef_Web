...
var Loading={
	init: function (opt, callback){
		...
		afterTextureLoad(textures[0],function (){
			...
			var opts={sprite:{textures:t, opt:{anchor:{x:0.5,y:1}}},text:{data: locales["#loading"], position: {x: 0, y: 0}, anchor:{x:0.5,y:0}, style: { fill: "#ffffff", stroke: "#000000",strokeThickness:2}}};
